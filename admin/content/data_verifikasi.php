                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row['role'] ?></td>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $row['id_user'] ?>">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>

                                        <button type="button" class="btn btn-danger btn-sm" id="hapus<?= $row['id_user'] ?>">
                                            ...
                                            <div class="modal-body">
                                                <form action="aksi/aksi_user.php" method="post">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="id" aria-describedby="emailHelp" name="id" value="<?= $row['id_user'] ?>" readonly>
                                                    </div>
                                                    <!-- batas -->
                                                    <div class="mb-3">
                                                        <label for="user" class="form-label">Username</label>
                                                        <input type="text" class="form-control" id="user" aria-describedby="emailHelp" name="username" value="<?= $row['username'] ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="pass" class="form-label">Password</label>
                                                        <input type="password" class="form-control" id="pass" aria-describedby="emailHelp" name="password" value="<?= $row['password'] ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="nama" class="form-label">Nama Lengkap</label>
                                                        <input type="text" class="form-control" id="nama" aria-describedby="emailHelp" name="nama" value="<?= $row['nama_lengkap'] ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="no" aria-describedby="emailHelp" name="no_hp" value="<?= $row['no_hp'] ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="no" class="form-label">Role</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="aksi/aksi_user.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="no" class="form-label">No.Hp.</label>
                        <input type="text" class="form-control" id="no" aria-describedby="emailHelp" name="no_hp" required>
                    </div>
                    <div class="mb-3">
                        <label for="no" class="form-label">Role</label>
                        <select name="role" class="form-select" aria-label="Default select example">
